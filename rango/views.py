...
def index(request):
    ...
    # Note the key boldmessage is the same as {{ boldmessage }} in he template!
    context_dict = {}
    context_dict = {'boldmessage':
                    'Crunchy, creamy, cookie, candy, cupcake!'}

    # Return a rendered responde to send to the client.
...
def donutchart(request):
    return render(request, 'rango/donutchart.html')
